...
const QuizCard = ({ quiz, onPlay }) => (
  <Card hover className="flex flex-col h-full">
    <div className="h-32 bg-slate-100 dark:bg-slate-700/50 relative overflow-hidden">
       ...
       <div className="absolute top-3 left-3">
         <span className="px-2 py-1 text-xs font-bold bg-white/90 dark:bg-black/50 backdrop-blur rounded-md uppercase tracking-wider">{quiz.category}</span>
       </div>
    </div>
